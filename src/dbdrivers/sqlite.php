...
class JDatabaseSQLite extends JDatabase
{
	 ...
	 * Constructor.
	 *
	 * If we expect that the database does not exist, we might set $options['create_db'] to true.
	 *
	 * @param   array  $options  Array of database options with keys: database, create_db.
	 *
	 * @since   ¿
	 */
	...
	{
		//-- NOTE: If we return 'false' JDatabase will convert the field to an integer :( :( :(
		return true;
	}
